...
class HelpMod(loader.Module):
    ...
    strings = {"name": "Help",
               "bad_module": '<b>Module</b> "<code>{}</code>" <b>is not in the database!</b>',
               "single_mod_header": "<b>Information about</b> <u>{}</u>:\n",
               "single_cmd": "\n {}\n",
               "undoc_cmd": "There is no documentation for this command",
               "all_header": 'List of available modules from <a href="https://t.me/SomeScripts">{}</a>:\n\n',
               "mod_tmpl": '\n‣<a href="tg://user?id={}">{}</a>',
               "first_cmd_tmpl": "⋮( {}",
               "cmd_tmpl": " | {}",
